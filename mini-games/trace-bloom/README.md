...
Avoid red noise pulses. They damage your signal and can cut your trace. All enemies target the player only. They do not target or camp objective nodes. While tracing near a cyan node, the node creates a bloom field that pushes enemies away.
